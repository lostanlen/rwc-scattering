function poolfreq_batch(batch_id, setting, B)
%% Generate prefix string
prefix = setting2prefix(setting);

%% Dispatch poolfreq according to architecture
switch setting.arch
    case 'plain'
        poolfreq_handle = @poolfreq_plainS2;
    case 'joint'
        poolfreq_handle = @poolfreq_jointS2;
    case 'spiral'
        poolfreq_handle = @poolfreq_spiralS2;
end
